<template>
  <div>
    <h1 class="text-4xl text-black font-semibold py-10 px-5 text-center">
      {{ article.title }}
    </h1>
    <div class="flex flex-row items-center justify-center pb-10">
      <img
        src="https://api.adorable.io/avatars/66/abott@adorable.png"
        alt="avatar"
        class="rounded-full h-10 w-10 shadow"
      />
      <span class="text-base ml-4 text-gray-700">{{ article.author }}</span>
      <span class="text-base ml-4 text-gray-700">|</span>
